...
class QuickResponseSystem:
    def __init__(self):
        ...
        self.price_keywords = [
            'سعر', 'اسعار', 'أسعار', 'تكلفة', 'كلفة', 'تكاليف',
            'كم', 'فلوس', 'ريال', 'مبلغ', 'رسوم', 'أجور', 'اجور',
            'عرض', 'عروض', 'باقة', 'باقات', 'خصم', 'خصومات',
            'ثمن', 'مصاريف', 'مصروف', 'دفع', 'يكلف', 'تكلف', 'بكام'
        ]
        
        # جمل كاملة للأسعار
        self.price_phrases = [
            'كم السعر', 'ايش السعر', 'وش السعر', 'كم التكلفة',
...
📞 0556914447 / 0506207444 / 0537914445"""
        ...
        # استخدم واحد من هذه المواقع المجانية لرفع الصورة:
        # 1. imgur.com (الأفضل)
        # 2. postimg.cc  
        # 3. imgbb.com
        # 4. i.ibb.co
